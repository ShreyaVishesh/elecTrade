...
const CreateNFTModal: React.FC<CreateNFTModalProps> = ({
      ...
      const [biddingdeadline, setBiddingDeadline] = useState('2024-7-23')
            ...
            <div className='create-nft-modal'>
                  ...
                  <div className='modal-content'>
                        ...
                        <form onSubmit={handleSubmit}>
                              ...
                              <div className='form-group'>
                                    <label htmlFor='nftImage'>Offer Banner:</label>
                                    <input
                                          type='file'
                                          id='nftImage'
                              ...
                              <div className='form-group'>
                                    <label htmlFor='nftTitle'>Description</label>
                                    <input
                                          type='text'
                                          id='nftTitle'
                                          value={title}
                              ...
                              <div className='form-group'>
                                    <label htmlFor='nftPrice'>Energy Price per Unit:</label>
                                    <input
                                          type='text'
                                          id='nftPrice'
                                          value={price}
