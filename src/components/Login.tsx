...
const Login: React.FC = () => {
      ...
      const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
            ...
            try {
                  const response = await axios.post('http://localhost:5173/api/v1/users/login', userDetails, {
                        headers: {
                              'Content-Type': 'application/json'
                        }
                  });
                  if (response.status === 200) {
                        localStorage.setItem('loggedInUser', JSON.stringify(response.data.data.loggedInUser));
                        navigate('/');
                  } else {
                        console.log('Error');
                  }
                              ...
                              <div className="p-5">
                                    ...
                                    <form className="w-full" onSubmit={handleSubmit}>
                                          ...
                                          <input
                                                ...
                                                value={userDetails.username || userDetails.email}
                                          ...
                                          <p className="mb-3 mt-2 text-sm text-gray-500">
                                                <a href="/forgot-password" className="text-blue-800 hover:text-blue-600 text-sm">Reset your password?</a>
                                          </p>
                                    ...
                                    <Link to="/signup">
                                          <div className="mt-6 text-center text-sm text-slate-600">
                                                ...
                                                <span className="font-medium text-[#4285f4] cursor-pointer">Sign up</span>
                                          </div>
                                    </Link>
                              </div>
                        </div>
